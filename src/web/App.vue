...
<template>
  ...
  <PlaceholderPage v-else :route="{ path: currentPath, title: 'Workflow Not Found', description: 'This route is not part of the current Gnosis Inventory MVP navigation.', action: 'Back to Dashboard', actionHref: '/dashboard' }" />
</template>
